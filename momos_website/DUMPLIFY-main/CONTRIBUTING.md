# Contributing to `DUMPLIFY` 
  
 A big welcome and thank you for considering contributing to **DUMPLIFY** open source project! 😀
 ...
 * To discuss potential changes before a PR is created 
 ...
 You can check the existing issues and create new issues from [here](https://github.com/RIKI-05/DUMPLIFY/issues)
